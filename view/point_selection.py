    ...
    def inner_html(self):
        return html.Div([
            ...
            html.Div([
                ...
                described_input('Latent point (float list)', 'text', self.ids(2), ''),
                described_input('Method', 'dropdown', self.ids(3), [
                    'global view',
                    'local view',
                    'latent value',
        ...
        def select(
            ...
            *options,
            ...
            if triggered_id == self.submit[0]:
                ...
                latent, point_2d = select_point(settings, global_click, local_click, options)
